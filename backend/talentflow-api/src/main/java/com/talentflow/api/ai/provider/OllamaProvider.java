...
public class OllamaProvider implements AiProvider {
    ...
    public String getName() {
        return AiProviderType.OLLAMA.id();
    }

    @Override
    public boolean isConfigured() {
        return properties.getOllama().getBaseUrl() != null
    ...
    public AiProviderResult generate(String systemPrompt, String userPrompt) {
        ...
        String url = properties.getOllama().getBaseUrl().replaceAll("/$", "") + "/api/chat";
    ...
    private AiProviderResult networkError(String model, RestClientException e, long elapsed) {
        return AiProviderResult.builder()
                ...
                .failureReason("Ollama not reachable: " + e.getMessage())
                .build();
    }
    ...
    private AiProviderResult notConfigured() {
        return AiProviderResult.builder()
                ...
                .reachable(false)
                .quotaAvailable(false)
                .failureReason("Ollama base URL is not configured")
                .build();
    }
}
